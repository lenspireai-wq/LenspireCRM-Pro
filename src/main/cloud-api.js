...
const deletePlatformOrganization = (token, organizationId) => request('/api/platform/organizations/' + encodeURIComponent(organizationId), authorized(token, {
  method: 'DELETE'
}));
...
module.exports = { API_BASE_URL, login, refresh, changePassword, listUsers, createUser, setUserDepartmentAccess, setUserRole, setUserActive, resetUserPassword, listPlatformOrganizations, createPlatformOrganization, setPlatformOrganizationStatus, deletePlatformOrganization, updatePlatformOrganizationSubscription, updatePlatformOrganizationBranding, uploadPlatformOrganizationLogo, listLeads, importLeads, createLead, updateLead, deleteLead, resetBusinessData, selectCloudWorkspace, getWorkspace, saveSalesTarget, saveEvent, deleteEvent, bulkUpdateEvents, savePhotographer, deletePhotographer, updateProduction, addPayment, updatePayment, deletePayment, createClientPortalLink, getClientPortalAccess, revokeClientPortalAccess, portalLogin, portalSetupPassword, portalInvite, convertLead, createBackup, createEncryptedBackup, restoreBackup, mutateWorkspace, listLeadActivities, importLeadActivities, createLeadActivity, updateLeadAttachment, googleConnect, uploadDriveFile, listDriveFiles, deleteDriveFile, listAutoBackups, getLatestAutoBackup, triggerAutoBackup, deleteAutoBackup, getAutoBackupConfig, setAutoBackupConfig };
