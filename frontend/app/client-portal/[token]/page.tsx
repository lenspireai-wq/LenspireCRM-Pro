...
export default function ClientPortalPage() {
  ...
  return <main className="clientPortal">
    ...
    <footer className="clientPortalOwnership">
      <p>For help, contact {data.studio.phone || data.studio.email || data.studio.name}.</p>
      <p><b>{data.studio.name}</b> uses LenspireAI as its technology service provider. All studio services, client relationships, and content provided through this portal are owned and managed by {data.studio.name}.</p>
    </footer>
